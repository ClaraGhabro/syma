        ...
        try {
            ...
            //	System.out.println(sCurrentLine);
                for (String mapElt : sCurrentLine.split(" ")) {
                    ...
                    switch (mapElt) {
                        case "F": { // Forest
                        	Place forest = new Place(j, i, grid, PlaceType.FOREST, 5, 10, 5);
                        	place.add(forest);
                        	context.add(forest);
                        ...
                        case "f": { // Field 
                        	Field field = new Field(j, i, grid, 5, 8, 8);
                        	place.add(field);
                        	context.add(field);
                        ...
                        case "H": { // House 
                        	nbHouse++;
                        	House house = new House(j, i, grid, 3, 3, 3);
                        	place.add(house);
                        	context.add(house);
                        ...
                        case "R": { // Road
                        	Place road = new Road(j, i, grid, 3, 3, 3);
                        	place.add(road);
                        	context.add(road);
                        ...
                        case "L": { // Land
                        	Place land = new Place(j, i, grid, PlaceType.LAND, 5, 5, 5);
                        	place.add(land);
                        	context.add(land);
                        	grid.moveTo(land,  j, i);
                        	break; }
                        case "C": { // Concrete
                        	Place concrete = new Place(j, i, grid, PlaceType.CONCRETE, 5, 3, 3);
                        	place.add(concrete);
                        ...
                        case "P" : { // Park
                        	Place park = new Place(j, i, grid, PlaceType.PARK, 1, 5, 5);
                        	place.add(park);
                        	context.add(park);
